  ...
  const onSubmit = async (data: FormData) => {
    try {
      await mutateAsync({
        ...
        proposedTime: data.proposedTime, // formatTime handles :00 suffix
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md glass p-6 shadow-2xl shadow-violet-500/10">
